...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/NevermoreSSH/nitro/main/izin > /root/tmp
...
echo -e " $COLOR1│$NC   ${COLOR1}[05]${NC} • CHECK CONFIG${NC}                        ${NC} $COLOR1│$NC"
